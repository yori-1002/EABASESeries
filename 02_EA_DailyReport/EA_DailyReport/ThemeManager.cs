    ...
    public static class ThemeManager
    {
        ...
        private static void apply_theme(string theme)
        {
            ...
            switch (theme)
            {
                ...
                case "pink": // ピンク
                    // ▼▼▼ 修正：サイドバーを暗い赤紫から淡いローズピンクに変更 ▼▼▼
                    set_color(res, "color_primary", "#9C5080");
                    set_color(res, "color_primary_light", "#C06898");
                    set_color(res, "color_accent", "#F48FB1");
                    set_color(res, "color_accent_hover", "#E91E63");
                    set_brush(res, "brush_primary", "#9C5080");
                    set_brush(res, "brush_primary_light", "#C06898");
